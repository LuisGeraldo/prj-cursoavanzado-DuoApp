package net.azurewebsites.luiscontrerasdev.duokapp.net.azurewebsites.ubicacion;
...
public class Ubicacion{
    ...
    public  Ubicacion(LocationStringListener listener, Context context){
    ...
    private void setAddressNameFromLocation() {
        try {
            ...
            listener.updateAddress(addresses.get(0).getAddressLine(0));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
